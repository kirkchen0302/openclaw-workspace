      ...
      {[0, 1, 2].map((d) => (
        <div
          ...
          style={{
            ...
            animation: `aichat5-bounce 1.2s infinite ${d * 0.2}s`,
          }}
        />
      ))}
    </div>
...
// ── Main component ──────────────────────────────────────────────────────
export default function AIChatV5({
  invoices,
  invoiceCount,
  totalAmount,
  monthlyTrend,
  ...
  return (
    ...
    >
        ...
        <>
          ...
          <div
            style={{
              ...
              animation: "aichat5-slideUp 0.3s ease",
            }}
          >
      ...
      <style>{`
        @keyframes aichat5-slideUp {
          from { transform: translateY(100%); }
          to { transform: translateY(0); }
        }
        @keyframes aichat5-bounce {
